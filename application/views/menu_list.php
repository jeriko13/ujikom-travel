    ...
    <div class='col-xs-12'>
      <div class='box'>
        <div class='box-header'>
          <h3 class='box-title'>MENU LIST <?php echo anchor('menu/create/', 'Create', array('class' => 'btn btn-info btn-sm')); ?>
            ...
            <?php echo anchor(site_url('menu/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-danger btn-sm"'); ?></h3>
        </div><!-- /.box-header -->
        <div class='box-body'>
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align:center" width="140px">
                    <?php
                    echo anchor(site_url('menu/read/' . $menu->id), '<i class="fa fa-eye"></i>', array('title' => 'detail', 'class' => 'btn btn-dark btn-sm'));
                    echo '  ';
