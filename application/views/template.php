...
<head>
    ...
    <title>Travelin | Uji Kompetensi</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Aplikasi Travel</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Jeri Riswanto</span>
                            </a>
        ...
        <footer class="main-footer">
            ...
            <?php
            $year = date("Y");
            echo "<strong>Copyright &copy; " . $year . " <a href='https://jeriko13.w3spaces.com/'>Jeri Riswanto</a>.</strong> All rights reserved.";
            ?>
        </footer>
